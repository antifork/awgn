...
main(int argc, char *argv[])
{
    ...
    more::logprio(std::clog, more::logstreambuf::CRIT )   << __LOG_FUNCTION__ << ": LOG_CRIT   : hello world!" << std::endl;
    more::logprio(std::clog, more::logstreambuf::ERR  )   << __LOG_FUNCTION__ << ": LOG_ERR    : hello world!" << std::endl;
    more::logprio(std::clog, more::logstreambuf::WARNING) << __LOG_FUNCTION__ << ": LOG_WARNING: hello world!" << std::endl;
    more::logprio(std::clog, more::logstreambuf::NOTICE)  << __LOG_FUNCTION__ << ": LOG_NOTICE : hello world!" << std::endl;
    more::logprio(std::clog, more::logstreambuf::INFO)    << __LOG_FUNCTION__ << ": LOG_INFO   : hello world!" << std::endl;
    more::logprio(std::clog, more::logstreambuf::DEBUG)   << __LOG_FUNCTION__ << ": LOG_DEBUG  : hello world!" << std::endl;
